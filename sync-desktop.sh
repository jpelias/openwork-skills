...
BASE_PACKAGES="wget mc rar unrar chrony htop curl git unzip zip p7zip-full rsync neofetch btop vim"
...
echo "[1/12] Verificando conectividad..."
...
echo "[2/12] Detectando monitores..."
...
echo "[3/12] Cerrando sesión de $REMOTE_USER en destino..."
...
# ── 5. Chrony ──────────────────────────────────────────────────────────
echo "[6/12] Sincronizando chrony..."
...
# ── 6. Temas e iconos (TODO) ──────────────────────────────────────────
echo "[7/12] Sincronizando temas e iconos..."
...
echo "[9/12] Aplicando nombre de monitor..."
...
echo "    XFCE + MATE + LightDM + chrony + APT + paquetes"
echo "============================================"
